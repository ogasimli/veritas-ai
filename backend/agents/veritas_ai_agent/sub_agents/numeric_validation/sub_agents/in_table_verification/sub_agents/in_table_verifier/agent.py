"""In-Table Verifier sub-agent definition."""
...
from .schema import VerificationOutput

in_table_verifier_agent = LlmAgent(
    name="InTableCalcVerifierAgent",
    model="gemini-3-flash-preview",
    instruction=prompt.INSTRUCTION,
    output_key="verification_output",
    output_schema=VerificationOutput,
    tools=[tools.evaluate_formula],
