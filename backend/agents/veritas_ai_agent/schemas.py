...
class AgentError(BaseModel):
    ...
    is_error: bool = Field(default=True, description="Flag indicating an error occurred")
    agent_name: str = Field(..., description="Name of the agent that failed")
    error_type: str = Field(..., description="Category of error (e.g. rate_limit, server_error)")
